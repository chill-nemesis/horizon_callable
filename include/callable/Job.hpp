...
namespace HORIZON::CALLABLE
{
    ...
    namespace INTERNAL
    {
         ...
         *
         * @details This class is an interface for Job. Its main use is to provide a common type for storing jobs in a container (e.g. in a threadpool
         * implementation, see HORIZON::PARALLEL::ThreadPool). In addition, it works as a skeleton to prevent code duplication in the
